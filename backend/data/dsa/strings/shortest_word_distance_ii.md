...
Solve standard LeetCode problem **244: Shortest Word Distance II** (Medium).

## Pattern

Hash Map Indices + Two Pointers
...
Apply the **Hash Map Indices + Two Pointers** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
