...
Solve standard LeetCode problem **67: Add Binary** (Easy).

## Pattern

Bit Arithmetic Simulation / Two Pointers
...
Apply the **Bit Arithmetic Simulation / Two Pointers** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
