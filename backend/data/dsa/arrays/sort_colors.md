...
Solve standard LeetCode problem **75: Sort Colors** (Medium).
...
Apply the **Dutch National Flag / 3 Pointers** pattern to reduce the search space or eliminate redundant calculations.
