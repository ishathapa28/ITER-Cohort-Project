...
Solve standard LeetCode problem **31: Next Permutation** (Medium).
...
Apply the **Array Manipulation / Two Pointers** pattern to reduce the search space or eliminate redundant calculations.
