...
Solve standard LeetCode problem **249: Group Shifted Strings** (Medium).

## Pattern

Hash Map / Differences Key Normalization
...
Apply the **Hash Map / Differences Key Normalization** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
