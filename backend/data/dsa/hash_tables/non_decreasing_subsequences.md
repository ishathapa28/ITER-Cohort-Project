...
Solve LeetCode problem **491: Non-decreasing Subsequences** (Medium). 
...
**Backtracking + Level Hash Set Branch Pruning**
...
The optimal approach utilizes **Backtracking + Level Hash Set Branch Pruning** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
