...
Solve standard LeetCode problem **54: Spiral Matrix** (Medium).
...
Apply the **Matrix Traversal / Boundaries** pattern to reduce the search space or eliminate redundant calculations.
