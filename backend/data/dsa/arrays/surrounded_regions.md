...
Solve standard LeetCode problem **130: Surrounded Regions** (Medium).

## Pattern

BFS / DFS Boundary Traversal
...
Apply the **BFS / DFS Boundary Traversal** pattern to reduce the search space or eliminate redundant calculations.
