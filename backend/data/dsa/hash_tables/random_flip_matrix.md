...
Solve LeetCode problem **519: Random Flip Matrix** (Medium). 
...
**Hash Map Index Remapping + Fisher-Yates Shuffle**
...
The optimal approach utilizes **Hash Map Index Remapping + Fisher-Yates Shuffle** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
