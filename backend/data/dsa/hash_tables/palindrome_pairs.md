...
Solve LeetCode problem **336: Palindrome Pairs** (Hard). 
...
**Hash Map Word Index Lookup / Trie Suffix-Prefix Matching**
...
The optimal approach utilizes **Hash Map Word Index Lookup / Trie Suffix-Prefix Matching** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
