...
Solve standard LeetCode problem **219: Contains Duplicate II** (Easy).
...
Apply the **Sliding Window / Hash Map** pattern to reduce the search space or eliminate redundant calculations.
