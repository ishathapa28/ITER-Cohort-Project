...
Solve standard LeetCode problem **2316: Count Unreachable Pairs of Nodes in an Undirected Graph** (Medium).
...
**Union-Find (DSU) Component Size Multiplication Formula**
