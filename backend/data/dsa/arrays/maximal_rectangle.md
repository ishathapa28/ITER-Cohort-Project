...
Solve standard LeetCode problem **85: Maximal Rectangle** (Hard).
...
Apply the **Monotonic Stack / Dynamic Programming** pattern to reduce the search space or eliminate redundant calculations.
