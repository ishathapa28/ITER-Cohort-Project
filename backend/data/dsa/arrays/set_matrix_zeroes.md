...
Solve standard LeetCode problem **73: Set Matrix Zeroes** (Medium).
...
Apply the **In-place Matrix Marking** pattern to reduce the search space or eliminate redundant calculations.
