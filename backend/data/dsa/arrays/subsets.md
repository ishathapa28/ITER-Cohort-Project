...
Solve standard LeetCode problem **78: Subsets** (Medium).
...
Apply the **Backtracking / Bit Manipulation** pattern to reduce the search space or eliminate redundant calculations.
