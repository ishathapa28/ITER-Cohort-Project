...
Solve standard LeetCode problem **266: Palindrome Permutation** (Easy).

## Pattern

Character Odd-Frequency Counter Set
...
Apply the **Character Odd-Frequency Counter Set** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
