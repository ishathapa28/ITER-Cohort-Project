...
Solve standard LeetCode problem **28: Find the Index of the First Occurrence in a String** (Easy).

## Pattern

KMP Algorithm / Two Pointers
...
Apply the **KMP Algorithm / Two Pointers** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
