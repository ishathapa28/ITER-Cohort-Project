...
Solve standard LeetCode problem **126: Word Ladder II** (Hard).

## Pattern

BFS (Shortest Paths) + DFS Backtracking
...
Apply the **BFS (Shortest Paths) + DFS Backtracking** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
