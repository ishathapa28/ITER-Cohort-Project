...
Solve standard LeetCode problem **158: Read N Characters Given read4 II - Call Multiple Times** (Hard).

## Pattern

Internal Buffer / State Maintenance
...
Apply the **Internal Buffer / State Maintenance** pattern to reduce the search space or eliminate redundant calculations.
