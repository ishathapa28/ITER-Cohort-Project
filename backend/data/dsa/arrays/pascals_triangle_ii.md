...
Solve standard LeetCode problem **119: Pascal's Triangle II** (Easy).
...
Apply the **Dynamic Programming / Combinatorics** pattern to reduce the search space or eliminate redundant calculations.
