...
Solve standard LeetCode problem **84: Largest Rectangle in Histogram** (Hard).
...
Apply the **Monotonic Stack** pattern to reduce the search space or eliminate redundant calculations.
