...
Solve standard LeetCode problem **125: Valid Palindrome** (Easy).

## Pattern

Two Pointers (Filtering Non-Alphanumeric)
...
Apply the **Two Pointers (Filtering Non-Alphanumeric)** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
