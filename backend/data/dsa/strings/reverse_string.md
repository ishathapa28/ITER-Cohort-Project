...
Solve standard LeetCode problem **344: Reverse String** (Easy).
...
Apply the **Two Pointers (In-Place Swapping)** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
