...
Solve standard LeetCode problem **389: Find the Difference** (Easy).

## Pattern

Bit Manipulation (XOR) / Sum Difference
...
Apply the **Bit Manipulation (XOR) / Sum Difference** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
