...
Solve standard LeetCode problem **36: Valid Sudoku** (Medium).
...
Apply the **Hash Set / Matrix** pattern to reduce the search space or eliminate redundant calculations.
