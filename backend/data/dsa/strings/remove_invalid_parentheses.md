...
Solve standard LeetCode problem **301: Remove Invalid Parentheses** (Hard).

## Pattern

BFS / Backtracking with Minimal Removals
...
Apply the **BFS / Backtracking with Minimal Removals** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
