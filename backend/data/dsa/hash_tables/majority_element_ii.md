...
Solve LeetCode problem **229: Majority Element II** (Medium). 
...
**Extended Boyer-Moore Voting Algorithm / Hash Map Counts**
...
The optimal approach utilizes **Extended Boyer-Moore Voting Algorithm / Hash Map Counts** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
