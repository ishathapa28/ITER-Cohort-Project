...
Solve standard LeetCode problem **187: Repeated DNA Sequences** (Medium).

## Pattern

Sliding Window / Bit Manipulation / Hash Set
...
Apply the **Sliding Window / Bit Manipulation / Hash Set** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
