...
Solve standard LeetCode problem **1579: Remove Max Number of Edges to Keep Graph Fully Traversable** (Hard).
...
**Dual Union-Find (DSU) Priority Processing (Shared Type 3 Edges First)**
