...
Solve standard LeetCode problem **132: Palindrome Partitioning II** (Hard).

## Pattern

1D Dynamic Programming + Expand Center
...
Apply the **1D Dynamic Programming + Expand Center** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
