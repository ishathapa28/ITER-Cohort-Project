...
Solve standard LeetCode problem **14: Longest Common Prefix** (Easy).
...
Apply the **Horizontal / Vertical Scanning** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
