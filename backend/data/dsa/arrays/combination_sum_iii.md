...
Solve standard LeetCode problem **216: Combination Sum III** (Medium).
...
Apply the **Backtracking** pattern to reduce the search space or eliminate redundant calculations.
