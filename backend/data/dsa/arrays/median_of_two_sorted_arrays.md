...
Solve standard LeetCode problem **4: Median of Two Sorted Arrays** (Hard).
...
Apply the **Binary Search / Partitioning** pattern to reduce the search space or eliminate redundant calculations.
