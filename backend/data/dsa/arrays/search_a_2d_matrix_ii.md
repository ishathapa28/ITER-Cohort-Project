...
Solve standard LeetCode problem **240: Search a 2D Matrix II** (Medium).

## Pattern

Top-Right Pointer Elimination
...
Apply the **Top-Right Pointer Elimination** pattern to reduce the search space or eliminate redundant calculations.
