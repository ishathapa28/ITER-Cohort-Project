...
Solve standard LeetCode problem **43: Multiply Strings** (Medium).

## Pattern

Elementary Math Simulation / Array Storage
...
Apply the **Elementary Math Simulation / Array Storage** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
