...
Solve LeetCode problem **305: Number of Islands II** (Hard). 
...
**Hash Map Coordinate Mapping + Union-Find Structure**
...
The optimal approach utilizes **Hash Map Coordinate Mapping + Union-Find Structure** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
