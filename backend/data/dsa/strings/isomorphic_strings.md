...
Solve standard LeetCode problem **205: Isomorphic Strings** (Easy).

## Pattern

Two-Way Character Mapping (Hash Maps)
...
Apply the **Two-Way Character Mapping (Hash Maps)** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
