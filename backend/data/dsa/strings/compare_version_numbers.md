...
Solve standard LeetCode problem **165: Compare Version Numbers** (Medium).

## Pattern

Two Pointers / String Splitting & Parsing
...
Apply the **Two Pointers / String Splitting & Parsing** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
