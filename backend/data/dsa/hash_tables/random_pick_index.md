...
Solve LeetCode problem **398: Random Pick Index** (Medium). 
...
**Hash Map (Val -> List of Indices) / Reservoir Sampling**
...
The optimal approach utilizes **Hash Map (Val -> List of Indices) / Reservoir Sampling** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
