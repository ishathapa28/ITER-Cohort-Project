...
Solve standard LeetCode problem **247: Strobogrammatic Number II** (Medium).

## Pattern

Recursion / Divide and Conquer Construction
...
Apply the **Recursion / Divide and Conquer Construction** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
