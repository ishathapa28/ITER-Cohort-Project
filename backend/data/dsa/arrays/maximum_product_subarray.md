...
Solve standard LeetCode problem **152: Maximum Product Subarray** (Medium).

## Pattern

Dynamic Programming / Min-Max Track
...
Apply the **Dynamic Programming / Min-Max Track** pattern to reduce the search space or eliminate redundant calculations.
