...
Solve standard LeetCode problem **71: Simplify Path** (Medium).

## Pattern

Stack / Unix Path Parsing
...
Apply the **Stack / Unix Path Parsing** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
