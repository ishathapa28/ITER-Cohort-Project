...
Solve standard LeetCode problem **204: Count Primes** (Medium).
...
Apply the **Sieve of Eratosthenes** pattern to reduce the search space or eliminate redundant calculations.
