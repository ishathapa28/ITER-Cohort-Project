...
Solve standard LeetCode problem **340: Longest Substring with At Most K Distinct Characters** (Medium).

## Pattern

Sliding Window + Character Map
...
Apply the **Sliding Window + Character Map** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
