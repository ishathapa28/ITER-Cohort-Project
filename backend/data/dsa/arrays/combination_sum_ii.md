...
Solve standard LeetCode problem **40: Combination Sum II** (Medium).
...
Apply the **Backtracking / Sorting** pattern to reduce the search space or eliminate redundant calculations.
