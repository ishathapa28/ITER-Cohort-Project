...
Solve standard LeetCode problem **41: First Missing Positive** (Hard).
...
Apply the **Cyclic Sort / In-place Hashing** pattern to reduce the search space or eliminate redundant calculations.
