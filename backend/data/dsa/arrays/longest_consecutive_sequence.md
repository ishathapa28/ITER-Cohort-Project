...
Solve standard LeetCode problem **128: Longest Consecutive Sequence** (Medium).
...
Apply the **Hash Set** pattern to reduce the search space or eliminate redundant calculations.
