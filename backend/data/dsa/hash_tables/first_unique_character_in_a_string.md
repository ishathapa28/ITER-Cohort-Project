...
Solve LeetCode problem **387: First Unique Character in a String** (Easy). 
...
**Two-Pass Hash Map / Frequency Count Array**
...
The optimal approach utilizes **Two-Pass Hash Map / Frequency Count Array** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
