...
Solve standard LeetCode problem **80: Remove Duplicates from Sorted Array II** (Medium).
...
Apply the **Two Pointers** pattern to reduce the search space or eliminate redundant calculations.
