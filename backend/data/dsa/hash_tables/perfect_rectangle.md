...
Solve LeetCode problem **391: Perfect Rectangle** (Hard). 
...
**Hash Set Corner Count Matching + Area Calculation**
...
The optimal approach utilizes **Hash Set Corner Count Matching + Area Calculation** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
