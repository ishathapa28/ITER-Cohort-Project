...
Solve standard LeetCode problem **161: One Edit Distance** (Medium).

## Pattern

One Pass Scanning / Comparison
...
Apply the **One Pass Scanning / Comparison** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
