...
Solve standard LeetCode problem **163: Missing Ranges** (Easy).

## Pattern

Linear Scan / Range Construction
...
Apply the **Linear Scan / Range Construction** pattern to reduce the search space or eliminate redundant calculations.
