...
Solve standard LeetCode problem **140: Word Break II** (Hard).
...
Apply the **Backtracking + Memoization** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
