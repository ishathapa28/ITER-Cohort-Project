...
Solve standard LeetCode problem **392: Is Subsequence** (Easy).

## Pattern

Two Pointers Greedy Scan
...
Apply the **Two Pointers Greedy Scan** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
