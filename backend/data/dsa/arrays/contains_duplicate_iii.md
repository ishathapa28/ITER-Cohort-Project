...
Solve standard LeetCode problem **220: Contains Duplicate III** (Hard).

## Pattern

Bucket Sort / Sliding Window / TreeSet
...
Apply the **Bucket Sort / Sliding Window / TreeSet** pattern to reduce the search space or eliminate redundant calculations.
