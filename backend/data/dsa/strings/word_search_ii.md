...
Solve standard LeetCode problem **212: Word Search II** (Hard).

## Pattern

Trie + Matrix Backtracking DFS
...
Apply the **Trie + Matrix Backtracking DFS** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
