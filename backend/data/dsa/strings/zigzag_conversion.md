...
Solve standard LeetCode problem **6: Zigzag Conversion** (Medium).

## Pattern

String Simulation / Row Tracking
...
Apply the **String Simulation / Row Tracking** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
