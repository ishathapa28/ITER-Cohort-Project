...
Solve standard LeetCode problem **170: Two Sum III - Data structure design** (Easy).
...
Apply the **Design / Hash Map** pattern to reduce the search space or eliminate redundant calculations.
