...
Solve LeetCode problem **290: Word Pattern** (Easy). 
...
**Bi-directional Hash Map / Bijection Index Map**
...
The optimal approach utilizes **Bi-directional Hash Map / Bijection Index Map** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
