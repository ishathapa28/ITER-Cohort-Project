...
Solve standard LeetCode problem **2058: Find the Minimum and Maximum Number of Nodes Between Critical Points** (Medium).
...
**3-Node Window Traversal + First/Prev Critical Index Memory**
