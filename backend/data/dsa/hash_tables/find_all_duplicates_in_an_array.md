...
Solve LeetCode problem **442: Find All Duplicates in an Array** (Medium). 
...
**In-Place Index Negation Hashing**
...
The optimal approach utilizes **In-Place Index Negation Hashing** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
