...
Solve standard LeetCode problem **169: Majority Element** (Easy).
...
Apply the **Boyer-Moore Voting Algorithm** pattern to reduce the search space or eliminate redundant calculations.
