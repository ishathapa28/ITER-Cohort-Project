...
Solve LeetCode problem **264: Ugly Number II** (Medium). 
...
**Hash Set + Min-Heap / Three Pointers Dynamic Programming**
...
The optimal approach utilizes **Hash Set + Min-Heap / Three Pointers Dynamic Programming** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
