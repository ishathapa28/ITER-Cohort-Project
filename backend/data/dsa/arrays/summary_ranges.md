...
Solve standard LeetCode problem **228: Summary Ranges** (Easy).
...
Apply the **Two Pointers / Interval Construction** pattern to reduce the search space or eliminate redundant calculations.
