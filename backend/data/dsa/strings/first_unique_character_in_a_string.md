...
Solve standard LeetCode problem **387: First Unique Character in a String** (Easy).

## Pattern

Character Frequency Counting Array
...
Apply the **Character Frequency Counting Array** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
