...
Solve standard LeetCode problem **215: Kth Largest Element in an Array** (Medium).
...
Apply the **Quickselect / Min-Heap** pattern to reduce the search space or eliminate redundant calculations.
