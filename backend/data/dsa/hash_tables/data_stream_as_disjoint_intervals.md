...
Solve LeetCode problem **352: Data Stream as Disjoint Intervals** (Hard). 
...
**TreeMap / Red-Black Tree BST (Hash Map Equivalent Bounds)**
...
The optimal approach utilizes **TreeMap / Red-Black Tree BST (Hash Map Equivalent Bounds)** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
