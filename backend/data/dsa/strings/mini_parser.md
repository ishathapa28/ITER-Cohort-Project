...
Solve standard LeetCode problem **385: Mini Parser** (Medium).

## Pattern

Stack Iterative Parsing
...
Apply the **Stack Iterative Parsing** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
