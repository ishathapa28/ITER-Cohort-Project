...
Solve standard LeetCode problem **136: Single Number** (Easy).
...
Apply the **Bit Manipulation (XOR)** pattern to reduce the search space or eliminate redundant calculations.
