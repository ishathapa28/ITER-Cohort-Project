...
Solve standard LeetCode problem **108: Convert Sorted Array to Binary Search Tree** (Easy).
...
Apply the **Divide & Conquer / Binary Search** pattern to reduce the search space or eliminate redundant calculations.
