...
Solve standard LeetCode problem **213: House Robber II** (Medium).

## Pattern

Dynamic Programming (Circular)
...
Apply the **Dynamic Programming (Circular)** pattern to reduce the search space or eliminate redundant calculations.
