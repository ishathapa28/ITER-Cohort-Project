...
Solve standard LeetCode problem **394: Decode String** (Medium).

## Pattern

Stack with Multiplier and String Buffers
...
Apply the **Stack with Multiplier and String Buffers** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
