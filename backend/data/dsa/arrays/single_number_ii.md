...
Solve standard LeetCode problem **137: Single Number II** (Medium).

## Pattern

Bit Manipulation / Bit Counting
...
Apply the **Bit Manipulation / Bit Counting** pattern to reduce the search space or eliminate redundant calculations.
