...
Solve standard LeetCode problem **39: Combination Sum** (Medium).
...
Apply the **Backtracking / DFS** pattern to reduce the search space or eliminate redundant calculations.
