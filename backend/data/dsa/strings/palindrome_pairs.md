...
Solve standard LeetCode problem **336: Palindrome Pairs** (Hard).

## Pattern

Trie / Hash Map Prefix-Suffix Splitting
...
Apply the **Trie / Hash Map Prefix-Suffix Splitting** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
