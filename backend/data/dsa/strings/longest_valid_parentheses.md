...
Solve standard LeetCode problem **32: Longest Valid Parentheses** (Hard).

## Pattern

Stack / Dynamic Programming / Two Passes
...
Apply the **Stack / Dynamic Programming / Two Passes** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
