...
Solve standard LeetCode problem **316: Remove Duplicate Letters** (Medium).

## Pattern

Monotonic Stack + Last Occurrence Tracker
...
Apply the **Monotonic Stack + Last Occurrence Tracker** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
