...
Solve standard LeetCode problem **293: Flip Game** (Easy).

## Pattern

String Scan Traversal
...
Apply the **String Scan Traversal** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
