...
Solve standard LeetCode problem **221: Maximal Square** (Medium).
...
Apply the **Dynamic Programming / Matrix** pattern to reduce the search space or eliminate redundant calculations.
