...
Solve standard LeetCode problem **49: Group Anagrams** (Medium).

## Pattern

Hash Map / Key Categorization (Sorted String or Frequency Count)
...
Apply the **Hash Map / Key Categorization (Sorted String or Frequency Count)** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
