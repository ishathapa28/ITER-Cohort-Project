...
Solve standard LeetCode problem **56: Merge Intervals** (Medium).
...
Apply the **Sorting / Interval Merging** pattern to reduce the search space or eliminate redundant calculations.
