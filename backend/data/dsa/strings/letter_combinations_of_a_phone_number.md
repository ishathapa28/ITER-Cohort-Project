...
Solve standard LeetCode problem **17: Letter Combinations of a Phone Number** (Medium).
...
Apply the **Backtracking / DFS** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
