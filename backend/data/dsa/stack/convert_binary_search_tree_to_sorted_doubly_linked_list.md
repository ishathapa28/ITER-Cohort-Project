...
Solve standard LeetCode problem **426: Convert Binary Search Tree to Sorted Doubly Linked List** (Medium).
...
**Iterative Inorder Stack Traversal + Prev Node Rewiring**
