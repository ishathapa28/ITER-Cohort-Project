...
Solve standard LeetCode problem **174: Dungeon Game** (Hard).

## Pattern

Dynamic Programming (Bottom-Up Matrix)
...
Apply the **Dynamic Programming (Bottom-Up Matrix)** pattern to reduce the search space or eliminate redundant calculations.
