...
Solve standard LeetCode problem **200: Number of Islands** (Medium).
...
Apply the **BFS / DFS / Union Find** pattern to reduce the search space or eliminate redundant calculations.
