...
Hash Map Index Storage + Two Pointers
...
Apply the **Hash Map Index Storage + Two Pointers** pattern to reduce the search space or eliminate redundant calculations.
