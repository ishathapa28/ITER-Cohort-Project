...
Solve standard LeetCode problem **79: Word Search** (Medium).
...
Apply the **Backtracking / Grid DFS** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
