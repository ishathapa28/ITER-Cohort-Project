...
Solve standard LeetCode problem **87: Scramble String** (Hard).

## Pattern

Divide & Conquer + Memoization / DP
...
Apply the **Divide & Conquer + Memoization / DP** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
