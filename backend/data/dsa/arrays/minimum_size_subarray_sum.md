...
Solve standard LeetCode problem **209: Minimum Size Subarray Sum** (Medium).
...
Apply the **Sliding Window / Two Pointers** pattern to reduce the search space or eliminate redundant calculations.
