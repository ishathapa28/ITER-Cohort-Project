...
Solve LeetCode problem **381: Insert Delete GetRandom O(1) - Duplicates allowed** (Hard). 
...
**Hash Map (Value -> Set of Indices) + Dynamic Array**
...
The optimal approach utilizes **Hash Map (Value -> Set of Indices) + Dynamic Array** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
