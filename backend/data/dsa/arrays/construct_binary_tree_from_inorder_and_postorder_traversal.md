...
Solve standard LeetCode problem **106: Construct Binary Tree from Inorder and Postorder Traversal** (Medium).

## Pattern

Divide & Conquer / Hash Map
...
Apply the **Divide & Conquer / Hash Map** pattern to reduce the search space or eliminate redundant calculations.
