...
Solve standard LeetCode problem **257: Binary Tree Paths** (Easy).

## Pattern

DFS / String Path Tracking
...
Apply the **DFS / String Path Tracking** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
