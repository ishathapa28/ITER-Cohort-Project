...
Solve standard LeetCode problem **131: Palindrome Partitioning** (Medium).

## Pattern

Backtracking + Palindrome Checking DP
...
Apply the **Backtracking + Palindrome Checking DP** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
