...
Solve standard LeetCode problem **121: Best Time to Buy and Sell Stock** (Easy).

## Pattern

Single Pass / Track Minimum
...
Apply the **Single Pass / Track Minimum** pattern to reduce the search space or eliminate redundant calculations.
