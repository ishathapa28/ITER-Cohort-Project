...
Solve standard LeetCode problem **246: Strobogrammatic Number** (Easy).

## Pattern

Two Pointers Lookup Map
...
Apply the **Two Pointers Lookup Map** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
