...
Solve standard LeetCode problem **12: Integer to Roman** (Medium).

## Pattern

Greedy / Greedy Mapping Table
...
Apply the **Greedy / Greedy Mapping Table** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
