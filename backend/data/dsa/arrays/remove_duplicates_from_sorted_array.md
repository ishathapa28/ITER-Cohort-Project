...
Solve standard LeetCode problem **26: Remove Duplicates from Sorted Array** (Easy).
...
Apply the **Two Pointers (In-place)** pattern to reduce the search space or eliminate redundant calculations.
