...
Solve standard LeetCode problem **211: Design Add and Search Words Data Structure** (Medium).

## Pattern

Trie + Wildcard DFS Search
...
Apply the **Trie + Wildcard DFS Search** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
