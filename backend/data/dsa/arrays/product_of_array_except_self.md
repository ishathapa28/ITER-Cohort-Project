...
Solve standard LeetCode problem **238: Product of Array Except Self** (Medium).
...
Apply the **Prefix & Suffix Products** pattern to reduce the search space or eliminate redundant calculations.
