...
Solve LeetCode problem **159: Longest Substring with At Most Two Distinct Characters** (Medium). 
...
**Sliding Window + Hash Map Character Frequency**
...
The optimal approach utilizes **Sliding Window + Hash Map Character Frequency** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
