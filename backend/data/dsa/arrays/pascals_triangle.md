...
Solve standard LeetCode problem **118: Pascal's Triangle** (Easy).
...
Apply the **Dynamic Programming / Iterative** pattern to reduce the search space or eliminate redundant calculations.
