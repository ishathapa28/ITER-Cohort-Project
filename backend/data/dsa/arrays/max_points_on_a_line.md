...
Solve standard LeetCode problem **149: Max Points on a Line** (Hard).

## Pattern

Math / Slope Counting Hash Map
...
Apply the **Math / Slope Counting Hash Map** pattern to reduce the search space or eliminate redundant calculations.
