...
Solve standard LeetCode problem **38: Count and Say** (Medium).

## Pattern

Run-Length Encoding Iteration
...
Apply the **Run-Length Encoding Iteration** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
