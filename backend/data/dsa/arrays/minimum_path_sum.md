...
Solve standard LeetCode problem **64: Minimum Path Sum** (Medium).
...
Apply the **Dynamic Programming / Grid** pattern to reduce the search space or eliminate redundant calculations.
