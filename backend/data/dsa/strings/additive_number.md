...
Solve standard LeetCode problem **306: Additive Number** (Medium).

## Pattern

Backtracking / Big Integer Checking
...
Apply the **Backtracking / Big Integer Checking** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
