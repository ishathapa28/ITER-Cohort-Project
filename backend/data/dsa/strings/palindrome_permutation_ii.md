...
Solve standard LeetCode problem **267: Palindrome Permutation II** (Medium).

## Pattern

Backtracking Permutations on First Half
...
Apply the **Backtracking Permutations on First Half** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
