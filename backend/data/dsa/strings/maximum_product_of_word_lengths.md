...
Solve standard LeetCode problem **318: Maximum Product of Word Lengths** (Medium).

## Pattern

Bitmasking (Alphabet Representation)
...
Apply the **Bitmasking (Alphabet Representation)** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
