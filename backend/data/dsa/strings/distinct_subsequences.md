...
Solve standard LeetCode problem **115: Distinct Subsequences** (Hard).
...
Apply the **2D Dynamic Programming** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
