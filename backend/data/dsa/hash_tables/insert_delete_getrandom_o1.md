...
Solve LeetCode problem **380: Insert Delete GetRandom O(1)** (Medium). 
...
**Hash Map (Value -> Index) + Dynamic Array Swap-Pop**
...
The optimal approach utilizes **Hash Map (Value -> Index) + Dynamic Array Swap-Pop** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
