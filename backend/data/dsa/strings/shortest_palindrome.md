...
Solve standard LeetCode problem **214: Shortest Palindrome** (Hard).

## Pattern

KMP Lookup Table / String Processing
...
Apply the **KMP Lookup Table / String Processing** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
