...
Solve standard LeetCode problem **290: Word Pattern** (Easy).

## Pattern

Bijections Mapping (Two Hash Maps)
...
Apply the **Bijections Mapping (Two Hash Maps)** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
