...
Solve standard LeetCode problem **72: Edit Distance** (Medium).

## Pattern

2D Dynamic Programming (Levenshtein Distance)
...
Apply the **2D Dynamic Programming (Levenshtein Distance)** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
