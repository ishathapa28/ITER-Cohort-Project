...
Solve standard LeetCode problem **243: Shortest Word Distance** (Easy).
...
Apply the **Single-Pass Two Pointers** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
