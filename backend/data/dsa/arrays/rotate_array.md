...
Solve standard LeetCode problem **189: Rotate Array** (Medium).

## Pattern

Array Reverse Trick / Cyclic Swaps
...
Apply the **Array Reverse Trick / Cyclic Swaps** pattern to reduce the search space or eliminate redundant calculations.
