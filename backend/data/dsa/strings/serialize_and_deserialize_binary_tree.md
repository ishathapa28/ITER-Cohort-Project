...
Solve standard LeetCode problem **297: Serialize and Deserialize Binary Tree** (Hard).

## Pattern

Preorder Traversal Encoding with Null Markers
...
Apply the **Preorder Traversal Encoding with Null Markers** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
