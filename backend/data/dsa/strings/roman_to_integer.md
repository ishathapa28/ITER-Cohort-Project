...
Solve standard LeetCode problem **13: Roman to Integer** (Easy).

## Pattern

Hash Map / Right-to-Left Scan
...
Apply the **Hash Map / Right-to-Left Scan** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
