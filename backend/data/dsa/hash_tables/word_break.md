...
Solve LeetCode problem **139: Word Break** (Medium). 
...
**Hash Set Dictionary + Dynamic Programming / BFS**
...
The optimal approach utilizes **Hash Set Dictionary + Dynamic Programming / BFS** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
