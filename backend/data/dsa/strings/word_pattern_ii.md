...
Solve standard LeetCode problem **291: Word Pattern II** (Medium).

## Pattern

Backtracking + Bijection Mapping
...
Apply the **Backtracking + Bijection Mapping** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
