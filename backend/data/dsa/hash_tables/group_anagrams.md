...
Solve LeetCode problem **49: Group Anagrams** (Medium). 
...
**Hash Map / Frequency Array or Sorted String Canonical Key**
...
The optimal approach utilizes **Hash Map / Frequency Array or Sorted String Canonical Key** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
