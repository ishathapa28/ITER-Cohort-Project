...
Solve standard LeetCode problem **93: Restore IP Addresses** (Medium).

## Pattern

Backtracking / Segment Splitting
...
Apply the **Backtracking / Segment Splitting** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
