...
Solve standard LeetCode problem **159: Longest Substring with At Most Two Distinct Characters** (Medium).

## Pattern

Sliding Window / Map Frequency Tracking
...
Apply the **Sliding Window / Map Frequency Tracking** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
