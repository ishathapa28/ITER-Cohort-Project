...
Solve LeetCode problem **244: Shortest Word Distance II** (Medium). 
...
**Hash Map (Word -> List of Indices) + Two Pointers**
...
The optimal approach utilizes **Hash Map (Word -> List of Indices) + Two Pointers** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
