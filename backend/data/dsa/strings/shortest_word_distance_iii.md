...
Solve standard LeetCode problem **245: Shortest Word Distance III** (Medium).

## Pattern

Two Pointers with Same-Word State
...
Apply the **Two Pointers with Same-Word State** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
