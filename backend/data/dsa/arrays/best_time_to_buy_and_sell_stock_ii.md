...
Solve standard LeetCode problem **122: Best Time to Buy and Sell Stock II** (Medium).
...
Apply the **Greedy / Peak-Valley** pattern to reduce the search space or eliminate redundant calculations.
