...
Solve standard LeetCode problem **16: 3Sum Closest** (Medium).
...
Apply the **Two Pointers / Sorting** pattern to reduce the search space or eliminate redundant calculations.
