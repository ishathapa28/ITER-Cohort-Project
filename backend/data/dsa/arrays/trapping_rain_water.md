...
Solve standard LeetCode problem **42: Trapping Rain Water** (Hard).
...
Apply the **Two Pointers / Monotonic Stack / DP** pattern to reduce the search space or eliminate redundant calculations.
