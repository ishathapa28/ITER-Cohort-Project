...
Solve standard LeetCode problem **8: String to Integer (atoi)** (Medium).

## Pattern

Parsing / Boundary Handling
...
Apply the **Parsing / Boundary Handling** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
