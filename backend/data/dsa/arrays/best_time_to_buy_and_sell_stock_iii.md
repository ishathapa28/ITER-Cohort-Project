...
Solve standard LeetCode problem **123: Best Time to Buy and Sell Stock III** (Hard).
...
Apply the **Dynamic Programming / State Machine** pattern to reduce the search space or eliminate redundant calculations.
