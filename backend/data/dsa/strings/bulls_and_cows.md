...
Solve standard LeetCode problem **299: Bulls and Cows** (Medium).

## Pattern

One-Pass Frequency Array Tracking
...
Apply the **One-Pass Frequency Array Tracking** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
