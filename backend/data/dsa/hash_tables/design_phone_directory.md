...
Solve LeetCode problem **379: Design Phone Directory** (Medium). 
...
**Hash Set / Array Queue of Available Numbers**
...
The optimal approach utilizes **Hash Set / Array Queue of Available Numbers** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
