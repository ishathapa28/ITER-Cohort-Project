...
Solve standard LeetCode problem **239: Sliding Window Maximum** (Hard).
...
Apply the **Monotonic Queue / Deque** pattern to reduce the search space or eliminate redundant calculations.
