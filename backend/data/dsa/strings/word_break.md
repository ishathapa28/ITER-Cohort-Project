...
Solve standard LeetCode problem **139: Word Break** (Medium).
...
Apply the **Dynamic Programming / Trie** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
