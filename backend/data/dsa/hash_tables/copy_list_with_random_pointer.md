...
Solve LeetCode problem **138: Copy List with Random Pointer** (Medium). 
...
**Hash Map Node Mapping / Interleaved Node Nodes**
...
The optimal approach utilizes **Hash Map Node Mapping / Interleaved Node Nodes** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
