...
Solve standard LeetCode problem **154: Find Minimum in Rotated Sorted Array II** (Hard).
...
Apply the **Binary Search with Duplicates** pattern to reduce the search space or eliminate redundant calculations.
