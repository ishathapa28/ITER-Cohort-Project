...
Solve LeetCode problem **480: Sliding Window Median** (Hard). 
...
**Hash Map Lazy Deletion + Two Balanced Heaps**
...
The optimal approach utilizes **Hash Map Lazy Deletion + Two Balanced Heaps** to trade minimal memory space for immediate $\mathcal{O}(1)$ average lookups, eliminating redundant scans.
