...
Solve standard LeetCode problem **345: Reverse Vowels of a String** (Easy).

## Pattern

Two Pointers (Filtering Vowels)
...
Apply the **Two Pointers (Filtering Vowels)** strategy to prune invalid branches, avoid redundant character operations, or process string indices efficiently.
