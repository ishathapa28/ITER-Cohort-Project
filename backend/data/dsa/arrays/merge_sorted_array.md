...
Solve standard LeetCode problem **88: Merge Sorted Array** (Easy).

## Pattern

Two Pointers (Reverse Merging)
...
Apply the **Two Pointers (Reverse Merging)** pattern to reduce the search space or eliminate redundant calculations.
