...
Solve standard LeetCode problem **120: Triangle** (Medium).
...
Apply the **Dynamic Programming (Bottom-Up)** pattern to reduce the search space or eliminate redundant calculations.
