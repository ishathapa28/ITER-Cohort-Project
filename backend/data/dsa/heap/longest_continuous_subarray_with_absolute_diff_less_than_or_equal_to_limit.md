...
Solve standard LeetCode problem **1438: Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit** (Medium).
...
**Dual Monotonic Deques / Min-Max Dynamic Heaps**
