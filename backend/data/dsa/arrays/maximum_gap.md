...
Solve standard LeetCode problem **164: Maximum Gap** (Medium).
...
Apply the **Bucket Sort / Radix Sort** pattern to reduce the search space or eliminate redundant calculations.
